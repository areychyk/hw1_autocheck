...
function Clock() {
    ...
    const stringDay = Intl.DateTimeFormat('en-GB',{weekday: "long"}).format(date) || <br/> // пишут студенты
    const stringMonth = Intl.DateTimeFormat('en-GB',{month:'long'}).format(date) || <br/> // пишут студенты
